...
{
    openFile(QFileDialog::getOpenFileName(this, tr("Open map file"), SettingsManager::getValue("lastUsedDir", SettingsManager::getValue("dataPath", QStandardPaths::standardLocations(QStandardPaths::HomeLocation).first()).toString()).toString(), tr("All Compatible (*.gam *.wz)")));
}
